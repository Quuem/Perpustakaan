...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title"> Materi Pelatihan</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="row row-cards">
                        ...
                        <div class="row w-full">
                            <div class="col d-flex flex-column gap-2">
                                ...
                                <select id="filter-kategori" class="form-select" style="width: 200px;">
                                    <option selected disabled hidden>Pilih Materi Pelatihan</option>
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Pelatihan/Tambah') ?>"
                            ...
                            <div id="advanced-table" class="w-100">
                                <div class="row list justify-content-center">
                                    <?php foreach ($Pelatihan as $pelatihan) { ?>
                                        <div class="item col-md-4 mb-3 mt-3"
                                            data-kategori="<?= $pelatihan->nama_kategori ?>">
                                            <div class="card"
                                                style="max-width: 22rem; border: 3px solid #ced4da; box-shadow: 0 8px 12px rgba(0,0,0,0.15);">
                                                <img src="<?= base_url('Assets/KMS/Pelatihan/') . $pelatihan->gambar ?>"
                                                    alt="Preview" class="img-fluid w-100"
                                                    style="object-fit: cover; height: 200px; border-top: 1px solid #e3e3e3; border-radius: 6px;">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                                        <a href="<?= base_url('KM_Pelatihan/Detail/') . $pelatihan->pelatihan_id ?>"
                                                        ...
                                                        <?php if (
                                                            ...
                                                            <div class="d-flex gap-2">
                                                                <a href="<?= base_url('KM_Pelatihan/Edit/' . $pelatihan->pelatihan_id) ?>"
                                                                    class="btn btn-outline-success" title="Edit">
                                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                                </a>
                                                                <a href="#" data-bs-toggle="modal"
                                                                    data-bs-target="#delete-pelatihan-<?= $pelatihan->pelatihan_id ?>"
                                                                    class="btn btn-outline-danger"
                                                                    data-id="<?= $pelatihan->pelatihan_id ?>">
                                                                    <i class="fa-solid fa-trash"></i>
                                                                </a>

                                                                <div class="modal fade"
                                                                    id="delete-pelatihan-<?= $pelatihan->pelatihan_id ?>"
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <div class="w-100">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <a href="<?= base_url('KM_Pelatihan/deletePelatihan/' . $pelatihan->pelatihan_id) ?>"
            ...
            <script>
                const PAGE_COUNT_PELATIHAN = "PELATIHAN";

                const setPageListItems = (e) => {
                    const value = parseInt(e.target.value || e.target.dataset.value);
                    if (!value) return;

                    localStorage.setItem(PAGE_COUNT_PELATIHAN, value);
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    const savedPageCount = parseInt(localStorage.getItem(PAGE_COUNT_PELATIHAN)) || 3;
                    ...
                    deleteButtons.forEach(button => {
                        button.addEventListener("click", function () {
                            ...
                            const deleteUrl = `<?= base_url('KM_Pelatihan/deletePelatihan/') ?>${id}`;
