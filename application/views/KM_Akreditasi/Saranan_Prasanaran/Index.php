...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Akreditasi > Sarana Dan Prasarana</h2>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Akreditasi/Sarana_Dan_Prasarana/Tambah') ?>"
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-selectable">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-nama">Sarana Dan Prasarana</button>
                                        </th>
                                ...
                                <tbody class="table-tbody">
                                    <?php foreach ($SaranaDanPrasarana as $Kom) { ?>
                                        <tr data-kategori="<?= $Kom->nama_kategori ?>">
                                            <td class="nomor"></td>
                                            <td class="sort-nama "><?= $Kom->judul_komponen ?></td>
                                            <td class="sort-jumlah"><?= $Kom->deskripsi ?></td>

                                            <td class="sort-file">
                                                <?php if ($Kom->dokumen): ?>
                                                    <img src="<?= base_url('Assets/KMS/KM_Akreditasi/Sarana_Dan_Prasarana/' . $Kom->dokumen) ?>"
                                                        alt="Foto"
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Akreditasi/Sarana_Dan_Prasarana/Edit/') . $Kom->komponen_id ?>"
                                                        class="btn  btn-outline-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete-SarnanaPrasana<?= $Kom->komponen_id ?>"
                                        ...
                                        <div class="modal fade" id="delete-SarnanaPrasana<?= $Kom->komponen_id ?>"
                                            tabindex="-1" aria-hidden="true">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Akreditasi/Sarana_Dan_Prasarana/deleteSaranaPrasarana/' . $Kom->komponen_id) ?>"
            ...
            <script>
                const advancedTable = {
                    headers: [
                        ...
                        { "data-sort": "sort-jumlah", name: "Jumlah" },
                    ],
                };



                const PAGE_COUNT_PENGETAHUAN = "Sarana_Dan_Prasarana_PAGE_COUNT";
