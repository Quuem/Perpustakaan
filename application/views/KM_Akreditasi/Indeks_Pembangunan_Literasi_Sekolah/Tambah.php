        ...
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title"> KM Akreditasi >&nbsp; <a
                        ...
                        Indeks Pembangunan Literasi Sekolah </a> &nbsp;> Tambah Data</h2>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="">
                <form class="card" method="post"
                    action="<?= base_url('KM_Akreditasi/Indeks_Pembangunan_literasi_Sekolah/addIndeksPembangunanLiterasiSekolah') ?>"
                    enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="mb-5 row">
                            <label class="col-2 text-center col-form-label required">Judul : </label>
                            <div class="col-9">
