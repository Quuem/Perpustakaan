...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Akreditasi > Indeks Pembangunan Literasi Sekolah</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="row row-cards">
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Akreditasi/Indeks_Pembangunan_Literasi_Sekolah/Tambah') ?>"
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-selectable">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-nama">Indeks</button>
                                        </th>
                                        <?php if (
                                            $this->session->userdata('nama_role') == 'Admin' ||
                                            $this->session->userdata('nama_role') == 'Pustakawan'
                                ...
                                <tbody class="table-tbody">
                                    <?php foreach ($IndeksPembangunanLiterasiSekolah as $Kom) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="sort-file">
                                                <?php if (in_array($ext, ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt'])): ?>
                                                    <a href="<?= base_url('Assets/KMS/KM_Akreditasi/Indeks_Pembangunan_Literasi_Sekolah/' . $nama_file) ?>"
                                                        target="_blank">
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Akreditasi/Indeks_Pembangunan_Literasi_Sekolah/Edit/') . $Kom->komponen_id ?>"
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Akreditasi/Indeks_Pembangunan_Literasi_Sekolah/deleteKomponen/' . $Kom->komponen_id) ?>"
            ...
            <script>
                ...
                const PAGE_COUNT_PENGETAHUAN = "Indeks_Pembangunan_Literasi_Sekolah_PAGE_COUNT";
