        ...
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title"> KM Akreditasi > Penyelenggara >&nbsp; <a
                        ...
                        Program Perpustkaan </a> &nbsp;> Tambah Edit</h2>
        ...
        <div class="card">
            <div class="">
                <form class="card" method="post"
                    action="<?= base_url('KM_Akreditasi/Penyelenggara/Program_Perpustakaan/editProgramPerpustakaan/' . $ProgramPerpustakaan->komponen_id) ?>"
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col">
                                <textarea required name="Judul" class="form-control" data-bs-toggle="autosize"
                                    placeholder="Masukkan Judul"><?= $ProgramPerpustakaan->judul_komponen ?></textarea>
                                <?= form_error('Judul', '<small class="text-danger">', '</small>') ?>
                            </div>
                        </div>
                        <div class="mb-5 row">
                            <label class="col-3 col-form-label required">Program : </label>
                            <div class="col">
                                <textarea required class="form-control" name="Deskripsi" data-bs-toggle="autosize"
                                    placeholder="Masukkan Program"><?= $ProgramPerpustakaan->deskripsi ?></textarea>
                            ...
                            <div class="col">
                                <select name="Kategori" style="width: 265px;" required id="" class="form-select">
                                    <?php foreach ($Kategori as $kat): ?>
                                        <option <?= $kat->kategori_id == $ProgramPerpustakaan->kategori_id ? 'selected' : '' ?>
