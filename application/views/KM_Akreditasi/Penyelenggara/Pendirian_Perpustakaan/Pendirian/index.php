...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Akreditasi > Penyelenggara > Pendirian Perpustakaan > Pendirian</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="row row-cards">
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Akreditasi/Penyelenggara/Pendirian_Perpustakaan/Pendirian/Tambah') ?>"
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-nama">Judul Document</button>
                                        </th>
                                ...
                                <tbody class="table-tbody">
                                    <?php foreach ($Pendirian as $Kom) { ?>
                                        <tr data-kategori="<?= $Kom->nama_kategori ?>">
                                            ...
                                            <td class="sort-file">
                                                <?php if ($Kom->dokumen): ?>
                                                    <img src="<?= base_url('Assets/KMS/KM_Akreditasi/Penyelenggara/Pendirian_Perpustakaan/' . $Kom->dokumen) ?>"
                                                        alt="Foto"
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Akreditasi/Penyelenggara/Pendirian_Perpustakaan/Pendirian/Edit/') . $Kom->komponen_id ?>"
                                                        class="btn  btn-outline-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete-Pendirian<?= $Kom->komponen_id ?>"
                                        ...
                                        <div class="modal fade" id="delete-Pendirian<?= $Kom->komponen_id ?>" tabindex="-1"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Akreditasi/Penyelenggara/Pendirian_Perpustakaan/Pendirian/deletePendirian/' . $Kom->komponen_id) ?>"
            ...
            <script>
                ...
                const PAGE_COUNT_PENGETAHUAN = "Pendiriran_PAGE_COUNT";
