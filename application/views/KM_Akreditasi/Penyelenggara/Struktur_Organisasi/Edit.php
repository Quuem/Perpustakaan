        ...
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title"> KM Akreditasi > Penyelenggara >&nbsp; <a
                        ...
                        Struktur Organisasi </a> &nbsp;> Edit Data</h2>
        ...
        <div class="card">
            <div class="">
                <form class="card" method="post"
                    action="<?= base_url('KM_Akreditasi/Penyelenggara/Struktur_Organisasi/editStrukturOrganisasi/' . $StrukturOrganisasi->komponen_id) ?>"
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col">
                                <textarea required name="Judul" class="form-control" data-bs-toggle="autosize"
                                    placeholder="Masukkan Nama"><?= $StrukturOrganisasi->judul_komponen ?></textarea>
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col">
                                <textarea required class="form-control" name="Deskripsi" data-bs-toggle="autosize"
                                    placeholder="Masukkan Deskripsi TUgas"><?= $StrukturOrganisasi->deskripsi ?></textarea>
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col">
                                <textarea class="form-control" name="Deskripsi2" data-bs-toggle="autosize"
                                    placeholder="Masukkan Deskripsi TUgas"><?= $StrukturOrganisasi->deskripsi2 ?></textarea>
                            ...
                            <div class="col">
                                <select name="Kategori" style="width: 265px;" required id="" class="form-select">
                                    <?php foreach ($Kategori as $kat): ?>
                                        <option <?= $kat->kategori_id == $StrukturOrganisasi->kategori_id ? 'selected' : '' ?>
