...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Akreditasi > Penyelenggara > Struktur Organisasi</h2>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Akreditasi/Penyelenggara/Struktur_Organisasi/Tambah') ?>"
                            ...
                            <table class="table table-vcenter table-selectable">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="">
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-deskripsi">Jabatan</button>
                                        </th>
                                        <th class="">
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-tugas">Deskrisi Tugas</button>
                                        </th>
                                        <th>Aksi</th>
                                ...
                                <tbody class="table-tbody">
                                    <?php foreach ($StrukturOrganisasi as $Kom) { ?>
                                        <tr data-kategori="<?= $Kom->nama_kategori ?>">
                                            <td class="nomor"></td>
                                            <td class="sort-nama "><?= nl2br($Kom->judul_komponen) ?></td>
                                            <td class="sort-deskripsi"><?= nl2br($Kom->deskripsi) ?></td>
                                            <td class="sort-tugas"><?= nl2br($Kom->deskripsi2) ?></td>
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Akreditasi/Penyelenggara/Struktur_Organisasi/Edit/') . $Kom->komponen_id ?>"
                                                        class="btn  btn-outline-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete-Struktur_Organisasi<?= $Kom->komponen_id ?>"
                                        ...
                                        <div class="modal fade" id="delete-Struktur_Organisasi<?= $Kom->komponen_id ?>"
                                            tabindex="-1" aria-hidden="true">
                                            <div class="modal-dialog modal-sm modal-dialog-centered">
                                                <div class="modal-content">
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                    <div class="modal-tugas bg-danger"></div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Akreditasi/Penyelenggara/Struktur_Organisasi/deleteStrukturOrganisasi/' . $Kom->komponen_id) ?>"
            ...
            <script>
                const advancedTable = {
                    headers: [
                        ...
                        { "data-sort": "sort-tugas", name: "tugas" },
                ...
                const PAGE_COUNT_PENGETAHUAN = "Struktur_Organisasi_PAGE_COUNT";
