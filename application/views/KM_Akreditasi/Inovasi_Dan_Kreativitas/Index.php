...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Akreditasi > Inovasi Dan Kreativitas</h2>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-header">
                        <div class="row w-full">
                            <div class="col d-flex flex-column gap-2">
                                ...
                                <select id="filter-kategori" class="form-select" style="width: 295px;">
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Akreditasi/Inovasi_Dan_Kreativitas/Tambah') ?>"
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-selectable">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-nama">Inovasi Dan Kreativitas</button>
                                        </th>

                                        <th class="">
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-deskripsi">Deskripsi</button>
                                        </th>
                                ...
                                <tbody class="table-tbody">
                                    <?php foreach ($InovasiDanKreativitas as $Kom) { ?>
                                        <tr data-kategori="<?= $Kom->nama_kategori ?>">
                                            <td class="nomor"></td>
                                            <td class="sort-nama "><?= $Kom->judul_komponen ?></td>
                                            <?php if ($Kom->deskripsi): ?>
                                                <td class="sort-deskripsi"><?= $Kom->deskripsi ?></td>
                                            <?php else: ?>
                                                <td class="sort-deskripsi">Tidak ada deskripsi</td>
                                            <?php endif; ?>
                                            <td class="sort-file">
                                                <?php if ($Kom->dokumen): ?>
                                                    <img src="<?= base_url('Assets/KMS/KM_Akreditasi/Inovasi_Dan_Kreativitas/' . $Kom->dokumen) ?>"
                                                        alt="Foto"
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Akreditasi/Inovasi_Dan_Kreativitas/Edit/') . $Kom->komponen_id ?>"
                                                        class="btn  btn-outline-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete-Inovasi<?= $Kom->komponen_id ?>"
                                        ...
                                        <div class="modal fade" id="delete-Inovasi<?= $Kom->komponen_id ?>" tabindex="-1"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Akreditasi/Inovasi_Dan_Kreativitas/deleteInovasiDanKreativitas/' . $Kom->komponen_id) ?>"
            ...
            <script>
                const advancedTable = {
                    headers: [
                        ...
                        { "data-sort": "sort-deskripsi", name: "Jumlah" },
                    ],
                };



                const PAGE_COUNT_PENGETAHUAN = "Inovasi_Dan_Kreativitas_PAGE_COUNT";
