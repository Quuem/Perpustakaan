...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="card">
            <div class="">
                <form class="card" method="post" action="<?= base_url('KM_Akreditasi/Tenaga/addTenaga') ?>"
                    ...
                    <div class="card-body">
                        <div class="mb-5 row">
                            ...
                            <div class="col">
                                <input type="text" value="<?= set_value('Judul') ?>" class="form-control" name="Judul"
                                    placeholder="Masukkan Nama Pustakawan" required />
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col">
                                <input type="text" name="Deskripsi2" value="<?= set_value('Deskripsi2') ?>"
