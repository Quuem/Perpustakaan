...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Akreditasi > Tenaga</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="row row-cards">
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Akreditasi/Tenaga/Tambah') ?>"
                            ...
                            <table class="table table-vcenter table-selectable">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="">
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-deskripsi">Tugas Pokok</button>
                                        </th>
                                        <th>Aksi</th>
                                    ...
                                    <?php foreach ($Tenaga as $Kom) { ?>
                                        <tr data-kategori="<?= $Kom->nama_kategori ?>">
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Akreditasi/Tenaga/Edit/') . $Kom->komponen_id ?>"
                                                        class="btn  btn-outline-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete-Tenaga<?= $Kom->komponen_id ?>"
                                        ...
                                        <div class="modal fade" id="delete-Tenaga<?= $Kom->komponen_id ?>" tabindex="-1"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Akreditasi/Tenaga/deleteTenaga/' . $Kom->komponen_id) ?>"
            ...
            <script>
                ...
                const PAGE_COUNT_PENGETAHUAN = "Tenaga_PAGE_COUNT";
