        ...
        <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ms-lg-auto">
                <!-- <ul class="list-inline list-inline-dots mb-0">
                    ...
                    <li class="list-inline-item"><a href="<?= base_url('Assets') ?>/license.html"
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <!-- <ul class="list-inline list-inline-dots mb-0">
                    ...
                    <li class="list-inline-item">
                        <a href="<?= base_url('Assets') ?>/changelog.html" class="link-secondary" rel="noopener"> v1.2.0
                        </a>
                    </li>
                </ul> -->
            </div>
...
<script src="<?= base_url('Assets') ?>/libs/apexcharts/dist/apexcharts.min.js?1744816593" defer></script>
<script src="<?= base_url('Assets') ?>/libs/jsvectormap/dist/jsvectormap.min.js?1744816593" defer></script>
<script src="<?= base_url('Assets') ?>/libs/jsvectormap/dist/maps/world.js?1744816593" defer></script>
<script src="<?= base_url('Assets') ?>/libs/jsvectormap/dist/maps/world-merc.js?1744816593" defer></script>
<script src="<?= base_url('Assets') ?>/libs/list.js/dist/list.min.js?1744816593" defer></script>
<script src="<?= base_url('Assets') ?>/libs/autosize/dist/autosize.min.js?1744816592" defer></script>



<!-- END PAGE LIBRARIES -->
<!-- BEGIN GLOBAL MANDATORY SCRIPTS -->
<script src="<?= base_url('Assets') ?>/dist/js/tabler.min.js?1744816593" defer></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->
<!-- BEGIN DEMO SCRIPTS -->
<script src="<?= base_url('Assets') ?>/preview/js/demo.min.js?1744816593" defer></script>
<!-- END DEMO SCRIPTS -->
<!-- BEGIN PAGE SCRIPTS -->
