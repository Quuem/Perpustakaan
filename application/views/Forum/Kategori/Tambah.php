...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">
                    Forum >&nbsp;<a href="<?= base_url('Forum/Kategori') ?>"> Kategori</a> &nbsp;> Tambah
                    Data</h2>
            </div>
        </div>
    </div>
...
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            <div class="">
                <form class="card" method="post" action="<?= base_url('Forum/Kategori/addKategori') ?>"
                            ...
                            <div class="col-9">
                                <select id="filter-kategori" name="JenisKategori" class="form-select"
                                    ...
                                    <?php foreach ($JenisKategori as $Kat): ?>
                                        <option value="<?= htmlspecialchars($Kat) ?>"><?= htmlspecialchars($Kat) ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
