...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Forum > Kategroi</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="row row-cards">
                            ...
                            <div class="col-md-auto col-sm-12">
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <!-- Button -->
                                        <a href="<?= base_url('Forum/Kategori/Tambah') ?>"
                            ...
                            <table class="table table-vcenter table-selectable">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-nama">Kategori Forum</button>
                                        </th>
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-jenis">Jenis Kategori</button>
                                        </th>
                                ...
                                <tbody class="table-tbody">
                                    ...
                                    foreach ($Kategori as $row) { ?>
                                        <tr>
                                            <td class="nomor"></td>
                                            <td class="sort-nama"><?= $row->nama_kategori ?></td>
                                            <td class="sort-jenis"><?= $row->jenis_kategori ?></td>
                                            <td>
                                                <a href="<?= base_url('Forum/Kategori/Edit/') . $row->kategori_id ?>"
                                                    class="btn  btn btn-outline-success "><i
                                                        class="fa-solid fa-pen-to-square"></i></a>
                                                <a href="#" data-bs-toggle="modal"
                                                    data-bs-target="#delete-kategori<?= $row->kategori_id ?>"
                                        ...
                                        <!-- Modal Konfirmasi -->
                                        <div class="modal fade" id="delete-kategori<?= $row->kategori_id ?>" tabindex="-1"
                                            aria-hidden="true">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('Forum/Kategori/deleteKategori/' . $row->kategori_id) ?>"
            ...
            <script>
                ...
                const PAGE_COUNT_KATEGORI = "KATEGORI";

                const setPageListItems = (e) => {
                    const value = parseInt(e.target.dataset.value);
                    localStorage.setItem(PAGE_COUNT_KATEGORI, value);
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    const savedPageCount = parseInt(localStorage.getItem(PAGE_COUNT_KATEGORI)) || 10; // ambil dari localStorage, default 10
