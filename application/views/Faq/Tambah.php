...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">
                    <a href="<?= base_url('faq') ?>">FAQ</a> &nbsp;> Tambah FAQ
                </h2>
            </div>
        </div>
    </div>
...
<div class="page-body">
    <div class="container-xl">
        ...
        <!-- Card Form -->
        <div class="card">
            <form enctype="multipart/form-data" class="card" method="post" action="<?= site_url('Faq/addFaq') ?>">
                <div class="card-body">
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            <input type="text" name="judul_faq" class="form-control"
                                value="<?= set_value('judul_faq') ?>" placeholder="Masukkan Judul FAQ" required />
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            <textarea name="isi_faq" class="form-control" rows="5" placeholder="Masukkan Isi FAQ"
                                required><?= set_value('isi_faq') ?></textarea>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            <textarea name="isi2" class="form-control" rows="4"
                                placeholder="Masukkan Isi 2"><?= set_value('isi2') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            <textarea name="isi3" class="form-control" rows="4"
                                placeholder="Masukkan Isi 3"><?= set_value('isi3') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            <textarea name="isi4" class="form-control" rows="4"
                                placeholder="Masukkan Isi 4"><?= set_value('isi4') ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-5 row">
                        ...
                        <div class="col-9">
                            <textarea name="isi5" class="form-control" rows="4"
                                placeholder="Masukkan Isi 5"><?= set_value('isi5') ?></textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-9">
                            <select name="kategori_id" class="form-select" required>
                                ...
                                <?php foreach ($kategori as $kat): ?>
                                    <option value="<?= $kat->kategori_id ?>" <?= set_select('kategori_id', $kat->kategori_id) ?>>
