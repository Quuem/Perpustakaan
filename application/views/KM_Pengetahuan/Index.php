...
<div class="page-header d-print-none">
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">KM Pengetahuan</h2>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-xl">
        ...
        <div class="row row-cards">
                                ...
                                <div class="ms-auto d-flex flex-wrap btn-list">
                                    <div class="d-flex flex-column align-items-end gap-2">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="<?= base_url('KM_Pengetahuan/Tambah') ?>"
                            ...
                            <table class="table table-vcenter table-selectable">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button class="table-sort d-flex justify-content-between"
                                                data-sort="sort-nama">Penjaminan Mutu</button>
                                        </th>
                                        <?php if (
                                            $this->session->userdata('nama_role') == 'Admin' ||
                                            $this->session->userdata('nama_role') == 'Pustakawan'
                                ...
                                <tbody class="table-tbody">
                                    ...
                                    foreach ($Pengetahuan as $peng) { ?>
                                        ...
                                        <tr data-kategori="<?= $peng->nama_kategori ?>">
                                            <td><?= $i++ ?></td>
                                            <td class="sort-nama"><?= $peng->judul_pengetahuan ?></td>
                                            <?php
                                            $nama_file = $peng->file_pendukung;
                                            $ext = pathinfo($nama_file, PATHINFO_EXTENSION);
                                            ?>
                                            <td class="sort-file">
                                                <?php if (in_array($ext, ['pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx', 'txt'])): ?>
                                                    <a target="_blank"
                                                        href="<?= base_url('Assets/KMS/Pengetahuan/' . $nama_file) ?>">
                                            ...
                                            <?php if (
                                                ...
                                                <td>
                                                    <a href="<?= base_url('KM_Pengetahuan/Edit/') . $peng->pengetahuan_id ?>"
                                                        class="btn  btn-outline-success"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete-pengetahuan<?= $peng->pengetahuan_id ?>"
                                        ...
                                        <div class="modal fade" id="delete-pengetahuan<?= $peng->pengetahuan_id ?>"
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="w-100">
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a href="<?= base_url('KM_Pengetahuan/deletePengetahuan/' . $peng->pengetahuan_id) ?>"
            ...
            <script>
                ...
                const PAGE_COUNT_PENGETAHUAN = "PENGETAHUAN";
