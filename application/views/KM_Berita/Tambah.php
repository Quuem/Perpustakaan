...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="card">
            <div class="">
                <form class="card" method="post" action="<?= base_url('KM_Berita/addBerita') ?>"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col-9">
                                <input type="date" name="Tanggal" style="width: 150px" required class="form-control" />
                        ...
                        <div class="mb-5 row">
                            ...
                            <div class="col-9">
                                <input type="url" name="link_video" id="link_video" class="form-control"
                                    placeholder="https://www.youtube.com/watch?v=abcdefghijklmn">
                            </div>
                        </div>
